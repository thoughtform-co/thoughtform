 ...
 * desktop and — since ADR-125 U1 put dwells and cruise passes on the phone
 * paint clock — about 0.17–0.34 of the stage on every phone (the phase flips
 * at paint 0.2 and 0.48, both mid-pass), so no single fraction is safe
 * either: search for it.
 *
