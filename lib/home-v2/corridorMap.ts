...
export const CORRIDOR_MAP = [
  ...
  },
  {
    ...
    content: {
      ...
      supportHtml:
        "Intelligence becomes <em>capability</em> when it is grounded in your context and <em>fit to the work</em>.<br>We build that capability with your team, so they can run and evolve it.",
      floorHtml:
        "Intelligence becomes <em>capability</em> when it is grounded in your context and <em>fit to the work</em>.<br>We build that capability with your team, so they can run and evolve it.",
      telemetry: {
        sector: "03 · BUILD",
