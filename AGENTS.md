...
When path-scoped rules in [`.Codex/rules/`](.Codex/rules/) match your files, follow them. Don’t import the whole `sentinel/` tree into prompts — use ADRs, rules, and skills on demand to save context.
...
Stacking / gateway / hero / shield rules, checklists, and full regression history: [ADR-008](sentinel/decisions/008-landing-v7-background-layers.md) and `.Codex/skills/landing-v7-compositing/SKILL.md` (and brandmark ADR-010 for the fixed mark).
