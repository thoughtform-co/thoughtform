...
- **Continuum (vision beat):** [ADR-049](sentinel/decisions/049-continuum-rail-stage.md) — the brandmark returns to mid-prominence at #continuum; the tool ↔ collaborator spectrum reads as a bold horizontal axis across the mark's centre (Update 1 retired the edge-on waist-ring thumb), copy beneath; #continuum becomes a transparent stage and the corridor-exit ambient kill retargets to #practice (flag `CONTINUUM_RAIL_STAGE`)
