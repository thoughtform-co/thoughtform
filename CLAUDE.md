...
- **The Intelligence Map (the casefile's lead row):** [ADR-062](sentinel/decisions/062-intelligence-map-city.md) — a **city in three sheets** (board · unit · below grade) in ONE isometric, superseding ADR-061's morphing tile field. No sphere, no zoom ladder, no legend; every total derived. ⚠ author at **1280×720** (the viz box is 611×390 there) and read §Outstanding — sheets 02/03 and the EXPAND control are a known first cut
