      ...
      <div className="flex items-center gap-1">
        ...
        <button
          ...
          className={cn(
            ...
            element.locked 
              ...
              : "text-dawn-30 hover:text-dawn-50"
          )}
        ...
        <button
          ...
          className={cn(
            ...
            element.hidden 
              ? "text-dawn-30 hover:text-dawn-50" 
              : "text-dawn-50 hover:text-dawn-70"
          )}
...
export function LayerPanel() {
  ...
  const handleSelect = useCallback((id: string, addToSelectionFlag: boolean) => {
  ...
  const handleReorder = useCallback((newOrder: Element[]) => {
  ...
  const elements = [...(selectedSection?.elements ?? [])].sort(
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-dawn-50 text-xs">
          {isExpanded ? "▼" : "▶"}
        </span>
      </button>
