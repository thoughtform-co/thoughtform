  ...
  return (
    <>
      <div
        className={cn(
          "inline-block",
          isEditMode && "cursor-pointer relative"
        )}
        onClick={handleClick}
      >
        <Button 
          ...
          className={cn(
            className,
            isEditMode && "hover:ring-2 hover:ring-gold/30 hover:ring-offset-2 hover:ring-offset-void"
          )}
        >
          {config.text}
        </Button>
          ...
          >
            ...
            <div className="pt-4 border-t border-surface-700">
              ...
              <div className="bg-void p-4 rounded flex items-center justify-center">
                <Button variant={localConfig.variant}>
                  {localConfig.text || "BUTTON"}
                </Button>
              </div>
            </div>
