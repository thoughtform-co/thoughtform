...
export function Wordmark({ className = "", hideVectorI = false }: WordmarkProps) {
  return (
    ...
    >
      <defs>
        <style>{`.wm-dawn{fill:#ebe3d6}.wm-gold{fill:#caa554}`}</style>
      </defs>
      <path
        className="wm-dawn"
      ...
      <path
        className="wm-dawn"
        d="M598.29,273.54v9.93h-106.93v210.02h-25.94v-219.94h133-.13Z"
      />
      <path className="wm-dawn" d="M557,373.58h-70.27v9.93h70.27v-9.93Z" />
      <path
        className="wm-dawn"
        d="M734.59,483.95h-89.72v9.79h89.72v-9.79Z"
      />
      <path
        className="wm-dawn"
        d="M618.54,316.94h-25.94v133.39h25.94v-133.39h0Z"
      />
      <path
        className="wm-dawn"
        d="M786.47,316.94h-25.94v133.39h25.94v-133.39h0Z"
      />
      <path
        className="wm-dawn"
        d="M734.59,283.46v-9.53h-89.99v9.53h-25.94v33.48h25.94v-33.22h89.99v33.22h25.94v-33.48h-25.94Z"
      />
      <path
        className="wm-dawn"
        d="M644.87,450.47h-25.94v33.48h25.94v-33.48Z"
      />
      <path
        className="wm-dawn"
        d="M760.53,450.47h-25.94v33.48h25.94v-33.48Z"
      />
      <path
        className="wm-dawn"
        d="M912.58,283.46v100.31h-85.09v-100.31h85.09v-10.45h-111.16v220.74h26.07v-99.25h40.89v33.48h25.28v44.07h25.94v-44.07h-25.94v-33.48h18.92v-10.85h21.84v-100.31h-21.84v.13Z"
      />
      <path
        className="wm-dawn"
        d="M930.98,472.17h-11.38v21.7h11.38v-21.7Z"
      />
      <path
        className="wm-dawn"
        d="M1117.7,273.01v44.73h-25.67v43.27h-10.45v44.73h10.45v-44.73h25.67v132.6h25.81v-220.74h-25.81v.13Z"
      />
      <path
        className="wm-dawn"
        d="M1009.06,361.14v-43.27h-25.67v-44.73h-25.81v220.74h25.81v-132.6h25.67v44.73h10.45v-44.73h-10.45v-.13Z"
      />
      <path
        className="wm-dawn"
        d="M1035.26,405.87h-15.75v44.33h15.75v-44.33h0Z"
      />
      <path
        className="wm-dawn"
        d="M1081.84,405.87h-15.75v44.33h15.75v-44.33h0Z"
      />
      <path
        className="wm-dawn"
        d="M1066.09,450.2h-30.83v43.67h30.83v-43.67h0Z"
      />
      <path
        className="wm-dawn"
        d="M877.38,1.85v4.9c7.68-.13,15.62-.66,16.54,8.73l-.26,188.45c-1.72,8.2-9.66,6.48-16.28,6.48v4.9h59.68v-4.9c-14.03.93-16.54-.79-17.47-14.56v-87.47h68.95v95.68c0,6.48-12.04,6.88-16.54,6.22v4.9h59.82v-4.9c-7.28,0-15.48,1.72-16.54-7.81l.66-190.56c2.12-6.22,10.72-5.16,15.88-5.29V1.59h-59.68v4.9c3.97,0,9.4-.53,13.1,1.46,1.06.66,3.57,3.97,3.57,4.76v85.75h-67.62l-1.32-1.32V19.19c0-.26.79-5.69.93-6.35,1.72-7.54,10.32-6.35,16.41-6.35V1.46h-59.82.13l-.13.4Z"
      />
      <path
        className="wm-dawn"
        d="M301.33,1.72h-59.82v4.9h.93c1.99,0,4.76,0,7.41.26h.66c2.91.4,5.56,1.32,6.75,3.44.4.53,1.72,4.63,1.72,4.9v83.24h-69.87V15.22c0-.26,1.46-4.5,1.72-4.9,1.19-2.12,3.84-3.04,6.75-3.44h.66c2.65-.4,5.43-.26,7.41-.26h.93V1.72h-59.82v4.9h0c3.57.13,6.75,0,9.26.53h.53c4.1.79,6.88,3.18,7.68,9.93v181.43c-.93,12.57-5.96,12.44-17.47,11.91v4.9h59.82v-4.9h-7.68c-.66,0-1.46,0-2.12-.26-2.51-.4-4.63-1.32-5.96-3.71-.26-.66-1.72-4.63-1.72-4.9v-92.37h69.87v92.37c0,.26-1.46,4.23-1.72,4.9-1.32,2.38-3.57,3.31-5.96,3.71h-9.79v4.9h59.82v-4.9c-11.65.53-16.54.66-17.47-11.91V16.81c.79-6.75,3.44-9.13,7.68-9.93h.53c2.65-.4,5.82-.26,9.26-.26h0V1.59h0v.13Z"
      />
      <path
        className="wm-dawn"
