...
export const cockpitStyles = `
  ...
  /* Tensor Gold color with CRT glow effect */
  .question-morph .glitch-text-main {
    ...
    color: var(--gold, #caa554) !important;
    font-weight: 300 !important;
    font-family: var(--font-display, "PP Mondwest", serif) !important;
    text-shadow: 0 0 2px rgba(202, 165, 84, 0.8), 0 0 4px rgba(202, 165, 84, 0.4), 0 0 8px rgba(202, 165, 84, 0.2) !important;
  }
