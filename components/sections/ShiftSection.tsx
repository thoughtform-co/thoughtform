...
export function ShiftSection({ section }: ShiftSectionProps) {
  ...
  const updateCard = (index: number, updates: Partial<{ icon: string; title: string; description: string }>) => {
          ...
          {content.cards.map((card, index) => {
            ...
            return (
              ...
              >
                ...
                <div className={cn("font-mono text-2xs uppercase tracking-widest mb-4", colors.text)}>
                  {card.icon} {type}
                </div>
