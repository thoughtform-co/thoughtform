...
const defaultContent: MusingsContent = {
  ...
  articles: [
    { title: "Why AI for strategic & creative work needs a different approach", date: "Jun 10, 2025" },
    { title: "Stop asking if AI can be creative. Start asking who will teach it.", date: "May 6, 2025" },
