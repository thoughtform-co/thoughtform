...
export function FlyingCameraRig() {
  ...
  useFrame(() => {
    ...
    //
    // Epilogue v4 (2026-06-10 flywheel pass): `paintProgress` is
    // pinned at 1 across the epilogue, so the camera holds at
    // CAMERA_END while the world docks rightward via
    // `getEpilogueDockTransform` on the gyro assembly. No special-
    // case epilogue branch is needed.
