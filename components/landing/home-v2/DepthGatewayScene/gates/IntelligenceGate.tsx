 ...
 *
 * The wrapping shell layers (substrate brain + source orbits + outer
 * surfaces skin) are NOT mounted here — they arrive via the accreted
 * `BrandmarkAccretionShell`, which co-locates with the substrate
 * sphere at landing (both centred on
 ...
 * promoted the substrate cloud to a TRAVELING brandmark cloud
 * mounted at scene root. That experiment was reverted on user
 * feedback — the brandmark belongs on the DOM layer across travel
 * and only hands off to particles at the Build morph. The cloud is
 * therefore back inside this gate at the Intelligence anchor.
 */
