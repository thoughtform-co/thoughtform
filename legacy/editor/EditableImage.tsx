    ...
    <>
      <div
        className={cn(
          ...
          isEditMode &&
            "cursor-pointer hover:outline hover:outline-2 hover:outline-gold/30 hover:outline-offset-2 rounded transition-all",
          className
        )}
        onClick={handleClick}
      ...
      {showModal && (
        ...
        >
          ...
          >
            <h3 className="text-dawn font-mono text-sm uppercase tracking-widest">Edit Image</h3>
