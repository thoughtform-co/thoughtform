          ...
          <div className="p-3">
            {selectedSection ? (
              <>
                ...
                {/* Section dimensions */}
                <div className="mb-4">
                  <div className="font-mono text-2xs text-dawn-30 mb-1">Min Height</div>
                  <select
                ...
                <div className="mb-4">
                  ...
                  <BackgroundPicker
                    ...
                    onChange={(background) => updateSection(selectedSection.id, { background })}
                  />
                </div>
              </>
            ) : (
              <div className="text-center py-8">
                <div className="font-mono text-2xs text-dawn-30 mb-2">No section selected</div>
    ...
    <>
      <div className="mb-2">
        ...
        <div className="flex gap-1">
          <button
            onClick={() => onUpdate({ content: { ...content, fontFamily: "sans" } })}
            className={cn(
          ...
          <button
            onClick={() => onUpdate({ content: { ...content, fontFamily: "mono" } })}
            className={cn(
      ...
      <div>
        ...
        <div className="flex gap-1">
          {(["left", "center", "right"] as const).map((align) => (
            <button
              key={align}
              onClick={() => onUpdate({ content: { ...content, textAlign: align } })}
              className={cn(
                "flex-1 px-2 py-1 border font-mono text-2xs transition-colors",
