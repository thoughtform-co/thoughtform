...
const ELEMENT_COMPONENTS: Record<
  string,
  React.ComponentType<{ element: Element; isEditing: boolean }>
> = {
  text: TextElement,
  image: ImageElement,
  video: VideoElement,
...
export function DraggableElement({ element, containerRef }: DraggableElementProps) {
  ...
  const { selectElement, addToSelection, moveElement, resizeElement, removeElement, gridSize } =
    useEditorStore();
