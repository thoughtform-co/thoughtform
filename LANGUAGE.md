...
| **Log** | The arcs overview's second frame (ADR-118): the engagements listed per client under group heads, one-line rows, one FILLED row, against **the log's dossier**. Its rows are real links; the kind filter narrows them. |
