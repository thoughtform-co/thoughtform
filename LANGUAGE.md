...
| **Log** | The arcs overview's second frame (ADR-118): one bordered BLOCK per engagement (the client and the date over the title, since U1 — no group heads), one FILLED, a gutter from **the log's dossier**, both ending on one floor. Its blocks are real links; the kind filter narrows them. |
