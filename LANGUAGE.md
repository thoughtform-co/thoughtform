...
| **Manifest**  | The **left rail's station ladder** (ADR-031) — one bracketed slot per journey entry: **sockets** ahead, **seated modules** behind, one **powered** slot showing the active station's number + name. The services module is the **docked card ring** (layered-stack glyph).                                                                                                                                                                                            |
