...
export async function GET() {
  try {
    ...
    if (error) {
      // Anonymous route: the raw Postgres message can name columns and
      // constraints, so it goes to the server log, not the response.
      console.error("[GET /api/celestial/slots] db error:", error);
