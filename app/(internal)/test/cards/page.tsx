...
function CardLabInner() {
  ...
  return (
    <>
      ...
      <HUDFrame activeSection="lab" scrollProgress={0} onNavigate={() => {}} />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-16">
            ...
            <p className="text-dawn-50 max-w-xl">
              Exploring different card styles for the Thoughtform design system. Toggle accent
              styles to compare approaches.
            </p>
          </div>
          ...
          <section className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <CardFrame tier="content" index={1} title="Navigate" accent={activeAccent}>
                Map the AI landscape with clarity. Understand what&apos;s possible.
              </CardFrame>

              <CardFrame tier="content" index={2} title="Evaluate" accent={activeAccent}>
                Test what works for your specific context and constraints.
              </CardFrame>

              <CardFrame tier="content" index={3} title="Synthesize" accent={activeAccent}>
          ...
          <section className="mb-20">
            ...
            >
              <div className="max-w-xl mx-auto space-y-4">
                ...
                <p className="text-dawn text-lg">But AI isn&apos;t a tool to command.</p>
                <p className="text-dawn-70 text-base leading-relaxed">
          ...
          <section className="mb-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2">
                <CardFrame
                  ...
                  footer={
                    <div className="flex items-center justify-between">
                      <span className="font-mono text-2xs text-dawn-30">Feb 2025 · Keynote</span>
                ...
                >
                  <p className="mb-4">
                    Explore how AI navigates the latent space of language—and how understanding this
                    geometry unlocks creative collaboration.
                  </p>
                  <p className="text-dawn-30">A 45-minute journey through semantic terrain.</p>
                </CardFrame>
              </div>
