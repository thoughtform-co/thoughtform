...
export {
  vesselLettering as flaskLettering,
  vesselMarkCount as flaskMarkCount,
  vesselMass as flaskMass,
} from "./vesselRig";

/**
 * 30 · FLASKS — the vessel rig at the "flask" silhouette.
 *
...
export const FLASKS_VIEWBOX = "0 0 932 762";

export function VariantFlasks({ record }: IslVariantProps) {
  return <VesselRig record={record} shape="flask" />;
}
