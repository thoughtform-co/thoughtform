...
/**
 * /test/services-card-face-lab — internal look-dev for the #services CARD
 ...
 * elements over a full-bleed photo — gold chip, includes row, title, lede,
 * CTA — so a reader meets two headline-weight labels (the chip names the
 ...
 *   v0  the shipped bake — the reference we are trying to beat
 ...
 * lab's camera CALIBRATION against the live corridor's published hit rects —
 ...
 * the parent `(internal)/test` layout. Best viewed ≥1101×760.
 */
export const metadata: Metadata = {
  title: "Services Card Face Lab — Tight Face + Spec Plate (Internal)",
  description:
