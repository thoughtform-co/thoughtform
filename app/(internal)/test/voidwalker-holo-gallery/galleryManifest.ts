...
export const GALLERY_RUNS: readonly GalleryRun[] = [
  {
    ...
    title: "Azeroth v9 — two at his shoulders, and nothing in the middle",
    date: "2026-08-30",
    status: "SHIPPING",
    adr: "ADR-082 U17",
    summary: [
      "⚠ ONE WAVE, SIX CUTS. v9 is live; v8, v7 and v6 are what it came from, and the card below holds the wave's first cut and the companion-free control. This page is for comparison, not for a changelog — a card per version would say less than two that each carry their own findings.",
    ...
    assets: [
      {
        ...
        label: "v9 · imps only (live on the site)",
        note: "Fiendish 0.58m and Corefire 0.49m at his shoulders facing forward, and nothing in the middle. Byte-for-byte v8's scene with the class removed — nothing else was retuned, so the pair reads as the difference the class made.",
        mb: 2.22,
      },
      {
        id: "az-v8-idle",
      ...
      },
      {
        id: "az-v9-still",
        kind: "still",
        src: `${V5}/holo-still-azeroth-v9.jpg`,
        alphaSrc: `${V5}/holo-still-azeroth-v9.webp`,
        label: "poster",
