...
export const GALLERY_RUNS: readonly GalleryRun[] = [
  {
    ...
    title: "Azeroth v6–v7 — the green comes down, the imps become a court",
    date: "2026-08-30",
    status: "SHIPPING",
    adr: "ADR-082 U16",
    summary: [
      "⚠ ONE WAVE, FOUR CUTS. This card holds the two the owner's notes produced — v7 live, v6 beside it — and the card below holds the wave's first cut and the companion-free control. Three near-identical run cards would have said less than two that each carry their own findings: this page is for comparison, not for a changelog.",
    ...
    assets: [
      {
        ...
        label: "v7 · the spread arc (live on the site)",
        note: "Fiendish 0.44m · Corefire 0.72m · Imp 0.50m on a 150° arc, 0.42 deep by 0.525 wide. Stood off the figure on the owner's read.",
      },
      {
        id: "az-v6-idle",
        kind: "video",
      ...
      },
      {
        id: "az-v7-still",
        kind: "still",
        src: `${V5}/holo-still-azeroth-v7.jpg`,
        alphaSrc: `${V5}/holo-still-azeroth-v7.webp`,
        label: "poster",
