...
/**
 * /test/services-anchor-lab — internal look-dev for SEATING the #services
 ...
 * geometry — their corner crosses and frame are `display: none` and the
 ...
 * the parent `(internal)/test` layout. Best viewed ≥1101×760 (the menu
 * desktop gate).
 */
export const metadata: Metadata = {
  title: "Services Anchor Lab — Seating the Masthead (Internal)",
  description:
