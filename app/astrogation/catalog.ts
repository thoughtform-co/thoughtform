...
export const COMPONENTS: ComponentDef[] = [
  ...
  // Grids / HUDs
  {
    ...
    props: [
      ...
      { name: "showBorder", type: "boolean", default: false },
      { name: "width", type: "number", default: 300, min: 100, max: 600 },
      { name: "height", type: "number", default: 200, min: 100, max: 400 },
    ],
    defaultWidth: 300,
    defaultHeight: 200,
  },
  {
    ...
    props: [
      ...
      { name: "size", type: "number", default: 24, min: 12, max: 64 },
      { name: "color", type: "color", default: "#caa554" },
    ],
    defaultWidth: 32,
    defaultHeight: 32,
